...
public class StackExpression implements Expression {
    ...
    public StackExpression(String strExpression) {
        expressionList = ruleToExpressionList(strExpression);
    }


    private List<String> ruleToExpressionList(String ruleExpression) {
    ...
    public boolean interpret(Map<String, Long> stats) {
        ...
        for (String strExpr : expressionList) {
            if (strExpr.contains(">")) {
